...
pub const ENV_GRPC_PROCESSOR_ALLOW_INSECURE: &str =
    "CDK_MINTD_GRPC_PAYMENT_PROCESSOR_ALLOW_INSECURE";
...
impl GrpcProcessor {
    pub fn from_env(mut self) -> Self {
        ...
        if let Ok(allow_insecure) = env::var(ENV_GRPC_PROCESSOR_ALLOW_INSECURE) {
