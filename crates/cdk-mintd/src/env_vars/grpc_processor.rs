...
pub const ENV_GRPC_PROCESSOR_ADDRESS: &str = "CDK_MINTD_PAYMENT_BACKEND_GRPC_PAYMENT_PROCESSOR_ADDRESS";
pub const ENV_GRPC_PROCESSOR_PORT: &str = "CDK_MINTD_PAYMENT_BACKEND_GRPC_PAYMENT_PROCESSOR_PORT";
pub const ENV_GRPC_PROCESSOR_TLS_DIR: &str = "CDK_MINTD_PAYMENT_BACKEND_GRPC_PAYMENT_PROCESSOR_TLS_DIR";
