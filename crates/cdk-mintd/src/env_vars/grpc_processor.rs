...
// gRPC Payment Processor environment variables
pub const ENV_GRPC_PROCESSOR_SUPPORTED_UNITS: &str = "CDK_MINTD_GRPC_PROCESSOR_SUPPORTED_UNITS";
pub const ENV_GRPC_PROCESSOR_ADDRESS: &str = "CDK_MINTD_GRPC_PROCESSOR_ADDRESS";
pub const ENV_GRPC_PROCESSOR_PORT: &str = "CDK_MINTD_GRPC_PROCESSOR_PORT";
pub const ENV_GRPC_PROCESSOR_TLS_DIR: &str = "CDK_MINTD_GRPC_PROCESSOR_TLS_DIR";
