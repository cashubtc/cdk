...
pub const ENV_FAKE_WALLET_SUPPORTED_UNITS: &str = "CDK_MINTD_PAYMENT_BACKEND_FAKE_WALLET_SUPPORTED_UNITS";
pub const ENV_FAKE_WALLET_FEE_PERCENT: &str = "CDK_MINTD_PAYMENT_BACKEND_FAKE_WALLET_FEE_PERCENT";
pub const ENV_FAKE_WALLET_RESERVE_FEE_MIN: &str = "CDK_MINTD_PAYMENT_BACKEND_FAKE_WALLET_RESERVE_FEE_MIN";
