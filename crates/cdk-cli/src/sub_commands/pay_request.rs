...
use cdk::nuts::{PaymentRequest, PaymentRequestPayload, SpendingConditions, Token};
...
pub async fn pay_request(
    ...
    let payment_request_con: Option<SpendingConditions> = payment_request
        .p2pk
        .as_ref()
    ...
    let prepared_send = matching_wallet
        .prepare_send(
            ...
            SendOptions {
                include_fee: true,
                conditions: payment_request_con,
                ..Default::default()
            },
        )
        .await?;
