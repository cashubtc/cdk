...
impl PaymentRequest {
    /// Borrow the core protocol request for wallet workflow conversion.
...
mod tests {
    ...
    #[test]
    fn payment_request_delivery_failure_exposes_reclaim_operation_id() {
        ...
        assert_eq!(reported_operation_id, Some(operation_id.to_string()));
