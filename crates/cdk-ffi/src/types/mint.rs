...
impl TryFrom<ProtectedEndpoint> for cdk::nuts::ProtectedEndpoint {
    ...
    fn try_from(endpoint: ProtectedEndpoint) -> Result<Self, Self::Error> {
        ...
        let route_path = match endpoint.path.as_str() {
            "/v1/mint/quote/bolt11" => cdk::nuts::RoutePath::MintQuote("bolt11".to_string()),
            "/v1/mint/bolt11" => cdk::nuts::RoutePath::Mint("bolt11".to_string()),
            "/v1/melt/quote/bolt11" => cdk::nuts::RoutePath::MeltQuote("bolt11".to_string()),
            "/v1/melt/bolt11" => cdk::nuts::RoutePath::Melt("bolt11".to_string()),
            ...
            "/v1/mint/quote/bolt12" => cdk::nuts::RoutePath::MintQuote("bolt12".to_string()),
            "/v1/mint/bolt12" => cdk::nuts::RoutePath::Mint("bolt12".to_string()),
            "/v1/melt/quote/bolt12" => cdk::nuts::RoutePath::MeltQuote("bolt12".to_string()),
            "/v1/melt/bolt12" => cdk::nuts::RoutePath::Melt("bolt12".to_string()),
            _ => {
                return Err(FfiError::Generic {
        ...
        cdk::nuts::Nuts {
            nut04: cdk::nuts::nut04::Settings {
                methods: vec![cdk::nuts::nut04::MintMethodSettings {
                    method: cdk::nuts::PaymentMethod::from("bolt11"),
            ...
            nut22: Some(cdk::nuts::BlindAuthSettings {
                ...
                protected_endpoints: vec![cdk::nuts::ProtectedEndpoint::new(
                    cdk::nuts::Method::Post,
                    cdk::nuts::RoutePath::Mint("bolt11".to_string()),
                )],
            }),
        }
    }
