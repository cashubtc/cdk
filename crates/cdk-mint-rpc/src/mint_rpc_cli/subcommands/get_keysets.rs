...
///
/// # Arguments
/// * `units` - Optional filter by units (comma-separated, e.g., "sat,usd")
/// * `exclude_inactive` - Only show active keysets
/// * `include_auth` - Include auth keysets
/// * `include_balances` - Include balance info
#[derive(Args)]
