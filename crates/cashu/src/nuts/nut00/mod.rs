...
#[cfg(feature = "wallet")]
use crate::nut28::{blind_public_key, ecdh_kdf};
...
pub struct Proof {
    ...
    /// P2BK Public Key for ECDH-handshake (NUT-28)
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ProofV3 {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dleq: Option<ProofDleq>,
    /// P2BK Public Key for ECDH (NUT-28)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub p2pk_e: Option<PublicKey>,
}
...
impl PreMintSecrets {
    ...
    ///
    /// Applies blinding to P2PK pubkeys according to NUT-28 specification.
