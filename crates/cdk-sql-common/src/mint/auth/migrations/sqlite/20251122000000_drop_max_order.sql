...
INSERT INTO keyset_new (id, unit, active, valid_from, valid_to, derivation_path, derivation_path_index, input_fee_ppk)
SELECT id, unit, active, valid_from, valid_to, derivation_path, derivation_path_index, input_fee_ppk
FROM keyset;
