-- Widen the columns whose value can outgrow a signed 32-bit one. Amounts are
-- u64 with no cap, a unix timestamp in int4 stops working in 2038, and
-- melt_quote's estimated_blocks and selected_fee_index are u32 values the
-- payment backend assigns.
--
