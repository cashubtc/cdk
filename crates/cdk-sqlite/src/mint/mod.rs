...
use cdk_common::{
    ...
    MeltBolt12Request, MeltQuoteState, MintInfo, MintQuoteState, PaymentMethod, Proof, Proofs,
...
fn sqlite_row_to_melt_request(row: SqliteRow) -> Result<(MeltRequest, PaymentProcessorKey), Error> {
