...
async fn test_htlc_requiring_preimage_and_one_signature() {
    ...
    let melt_request_preimage_only =
        cdk_common::MeltRequest::new(melt_quote_id.clone(), proofs_preimage_only, None);
    ...
    let melt_request_signature_only =
        cdk_common::MeltRequest::new(melt_quote_id.clone(), proofs_signature_only, None);
    ...
    let melt_request = cdk_common::MeltRequest::new(melt_quote_id.clone(), proofs_both, None);
