...
///
/// Verifies that after locktime, refund keys can spend
#[tokio::test]
async fn test_p2pk_locktime_after_expiry() {
    ...
    // TODO: Test spending with bob signature (should succeed - after locktime)
    // TODO: Test spending with alice signature (should fail - only refund keys valid)
}
