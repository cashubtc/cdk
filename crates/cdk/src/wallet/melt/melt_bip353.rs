...
impl Wallet {
    ...
    pub async fn melt_bip353_quote(
        ...
        let parsed_instruction =
            resolve_bip353_payment_instruction(&self.client, bip353_address).await?;
...
mod tests {
    ...
    async fn test_melt_bip353_quote_errors_when_resolved_uri_has_only_bolt11() {
        ...
        let error = wallet
            .melt_bip353_quote("alice@example.com", Amount::from(100_000_u64))
            .await
    ...
    async fn test_melt_bip353_quote_reports_invalid_resolved_uri() {
        ...
        assert!(matches!(error, Error::Bip353Resolve(_)));
    }
}
