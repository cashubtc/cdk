...
pub trait MintConnector: Debug {
    ...
    async fn get_mint_keys(&self, bat: Option<AuthToken>) -> Result<Vec<KeySet>, Error>;
    /// Get Keyset Keys [NUT-01]
    async fn get_mint_keyset(&self, keyset_id: Id, bat: Option<AuthToken>)
        -> Result<KeySet, Error>;
    /// Get Keysets [NUT-02]
    async fn get_mint_keysets(&self, bat: Option<AuthToken>) -> Result<KeysetResponse, Error>;
    /// Mint Quote [NUT-04]
    async fn post_mint_quote(
        &self,
        request: MintQuoteBolt11Request,
        bat: Option<AuthToken>,
