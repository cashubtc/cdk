...
post_cache_wrapper!(post_mint_onchain, MintRequest<QuoteId>, MintResponse);
post_cache_wrapper!(
    post_melt_onchain,
    MeltRequest<QuoteId>,
    MeltQuoteOnchainResponse<QuoteId>
);
...
) -> Result<Json<MintQuoteOnchainResponse<QuoteId>>, Response> {
    #[cfg(feature = "auth")]
    {
        state
            .mint
...
) -> Result<Json<MeltQuoteOnchainResponse<QuoteId>>, Response> {
    #[cfg(feature = "auth")]
    {
        state
            .mint
