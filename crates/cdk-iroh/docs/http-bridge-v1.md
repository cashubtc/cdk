...
- Connection establishment is bounded to 15 seconds, stream opening to 10
  seconds, header receipt to 15 seconds, body progress to 30 seconds, an
  ordinary HTTP transaction to 60 seconds, an idle admitted connection to five
  minutes, and graceful drain to 10 seconds.
...
The conformance test serves a route known only to its Axum router. The bridge
has no Cashu route table and performs no JSON translation.
