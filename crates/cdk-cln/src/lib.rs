...
use cdk::cdk_lightning::{self, Amount, InvoiceInfo, MintLightning, PayInvoiceResponse};
...
pub fn cln_invoice_status_to_status(status: ListinvoicesInvoicesStatus) -> MeltQuoteState {
    match status {
        ListinvoicesInvoicesStatus::UNPAID => MeltQuoteState::Unpaid,
        ListinvoicesInvoicesStatus::PAID => MeltQuoteState::Paid,
        ListinvoicesInvoicesStatus::EXPIRED => MeltQuoteState::Unpaid,
    }
}
